...
class _ImportdataState extends State<Importdata> {
  ...
  final List<int> priceexpense = List<int>.generate(2000, (i) => i + 1);
  final List<int> priceincome = List<int>.generate(2000, (i) => i + 1);
  ...
  int? expenseintselectedValue;
  final TextEditingController expenseintextEditingController =
      TextEditingController();

  int? incomeintselectedValue;
  final TextEditingController incomeintextEditingController =
      TextEditingController();
  @override
  void dispose() {
            ...
            child: Column(
              children: <Widget>[
                      ...
                      TextField(
                          ...
                          decoration: const InputDecoration(
                            icon: Icon(
                              ...
                              color: Color.fromARGB(255, 7, 20, 249),
                            ),
                            //icon of text field
                            labelText: "วันที่ : ",
                            labelStyle: TextStyle(
                                color: Color.fromARGB(255, 29, 0, 248),
                                fontSize: 16.0),
                            //label text of field
                          ),
                      ...
                      child: DropdownButtonHideUnderline(
                        child: DropdownButton2(
                          ...
                          items: priceexpense
                              ...
                              .toList(),
                          value: expenseintselectedValue,
                          onChanged: (value) {
                            setState(() {
                              expenseintselectedValue = value as int;
                            });
                          },
                          buttonHeight: 50,
                          buttonWidth: 90,
                          ...
                          scrollbarAlwaysShow: true,
                          offset: const Offset(-20, 0),
                          searchController: expenseintextEditingController,
                          searchInnerWidget: Padding(
                            padding: const EdgeInsets.only(
                              top: 8,
                              bottom: 8,
                            ...
                            child: TextFormField(
                              controller: expenseintextEditingController,
                              decoration: InputDecoration(
                                isDense: true,
                                contentPadding: const EdgeInsets.symmetric(
                                  horizontal: 10,
                          ...
                          onMenuStateChange: (isOpen) {
                            if (!isOpen) {
                              expenseintextEditingController.clear();
                            }
                          },
                        ),
                      ),
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton2(
                        ...
                        items: priceincome
                            ...
                            .toList(),
                        value: incomeintselectedValue,
                        onChanged: (value) {
                          setState(() {
                            incomeintselectedValue = value as int;
                          });
                        },
                        buttonHeight: 50,
                        buttonWidth: 90,
                        ...
                        scrollbarAlwaysShow: true,
                        offset: const Offset(-20, 0),
                        searchController: incomeintextEditingController,
                        searchInnerWidget: Padding(
                          padding: const EdgeInsets.only(
                            top: 8,
                            bottom: 8,
                          ...
                          child: TextFormField(
                            controller: incomeintextEditingController,
                            decoration: InputDecoration(
                              isDense: true,
                              contentPadding: const EdgeInsets.symmetric(
                                horizontal: 10,
                        ...
                        onMenuStateChange: (isOpen) {
                          if (!isOpen) {
                            incomeintextEditingController.clear();
                          }
                        },
                      ),
                    ),
                ...
                FloatingActionButton.extended(
                  onPressed: () {
                    setState(() {
                      var calincome = incomeintselectedValue;
                      var calexpense = expenseintselectedValue;
                      var cal = calincome! - calexpense!;
                      result.text =
                          "วันที่: ${dateController.text}\n${incomeselectedValue} ${incomeintselectedValue} บาท \n${expenseselectedValue} ${expenseintselectedValue} บาท \nคงเหลือ $cal บาท";
                      print(incomeselectedValue);
                      print(expenseselectedValue);
                      print(incomeintselectedValue);
                      print(expenseintselectedValue);
                    });
                    // Add your onPressed code here!
                  },
